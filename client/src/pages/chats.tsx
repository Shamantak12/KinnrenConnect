...
export default function Chats() {
  ...
  const chatList = [
    ...
    },
    {
      ...
      type: "group",
      avatar:
        "https://images.unsplash.com/photo-1609220136736-443140cffec6?w=150&h=150&fit=crop",
      ...
      <div className="min-h-screen max-w-md mx-auto bg-white">
        ...
        <div className="flex-1 p-4 space-y-4 pb-20">
          {messages.map((message) => (
            ...
            >
              <div
                className={`flex space-x-2 max-w-[80%] ${message.isMe ? "flex-row-reverse space-x-reverse" : ""}`}
              >
                {!message.isMe && (
                  <img
                    src={message.avatar}
                ...
                >
                  {!message.isMe && (
                    <p className="text-xs font-medium text-[#936cbf] mb-1">
                      {message.sender}
                    </p>
                  )}
        ...
        {filteredChats.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600">
              Try searching with different keywords or start a new conversation.
            </p>
          </div>
        ) : (
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {chat.type === "group" && (
                      <div className="flex items-center mt-1">
                        <Badge
                          variant="outline"
                          className="text-xs text-[#936cbf] border-[#936cbf]"
                        >
